# Ask AI to Map My Project to the Foundry Capability Boundary Table

> Bilingual mirror. Original source: `prep-artifacts/day-7/specs/spec-d10-foundry-limits.md`.
...
- Chinese canonical title: 让 AI 帮我对照 Foundry 能力边界表，找出我项目命中的边界
- English navigation title: Ask AI to Map My Project to the Foundry Capability Boundary Table
