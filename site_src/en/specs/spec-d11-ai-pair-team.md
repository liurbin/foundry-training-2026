# Team Spec Template Library Setup Guide (Instructor Demo)

> Bilingual mirror. Original source: `prep-artifacts/day-7/specs/spec-d11-ai-pair-team.md`.
...
- Chinese canonical title: 团队 spec 模板库搭建指南（讲师演示用）
- English navigation title: Team Spec Template Library Setup Guide (Instructor Demo)
