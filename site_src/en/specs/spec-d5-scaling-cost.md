# Ask AI to Deploy the D3 Single Agent to Hosted Agents, then Add Retry, Cache, and Cost Estimation

> Bilingual mirror. Original source: `prep-artifacts/day-7/specs/spec-d5-scaling-cost.md`.
...
- Chinese canonical title: 让 AI 帮我把 D3 的单 agent 部署到 Hosted Agents（主路径），并补 429 重试 + 缓存 + 成本估算；ACA 仅作对照
- English navigation title: Ask AI to Deploy the D3 Single Agent to Hosted Agents, then Add Retry, Cache, and Cost Estimation
