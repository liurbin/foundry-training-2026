# Agent Service vs Agent Framework SDK Decision Card

> Bilingual mirror. Original source: `prep-artifacts/day-7/specs/spec-d2-service-vs-sdk.md`.
...
- Chinese canonical title: Agent Service vs Agent Framework SDK 选型决策卡
- English navigation title: Agent Service vs Agent Framework SDK Decision Card
