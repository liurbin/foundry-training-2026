...
> Bilingual mirror. Original source: `workshop/docs/d07_multi_agent/index.md`.
...
- Chinese canonical title: D7: 多 agent 编排三选一
- English navigation title: D7: Three-Way Multi-Agent Orchestration Choice
- Scope: this page is part of the full bilingual Foundry training site.

## Chinese Source with Bilingual Headings

# D7: Three-Way Multi-Agent Orchestration Choice / D7: 多 agent 编排三选一
