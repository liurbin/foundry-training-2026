# Training Plan v2: AI-Native Developer Edition (3 Days)

> Bilingual mirror. Original source: `docs/00-training-plan-v2.md`.
...
- Chinese canonical title: 培训方案 v2：AI 原生开发者版（3 天）
- English navigation title: Training Plan v2: AI-Native Developer Edition (3 Days)
- Scope: this page is part of the full bilingual Foundry training site.

## Chinese Source with Bilingual Headings

# Training Plan v2: AI-Native Developer Edition (3 Days) / 培训方案 v2：AI 原生开发者版（3 天）
...
## 五·五、Foundry Capability Map（D1 必交付） / 五·五、Foundry 能力地图（D1 必交付）
...
## 五·六、每模块交付物Checklist（spec / negative examples / 验收） / 五·六、每模块交付物清单（spec / negative examples / 验收）
...
## 六、Day 1 议程：Foundry Capability Map + 平台路径 + Provider 抽象 / 六、Day 1 议程：Foundry 能力地图 + 平台路径 + Provider 抽象
...
## 八、Day 3 议程：Production + AI-pair 工作流 + 综合作业 / 八、Day 3 议程：生产化 + AI-pair 工作流 + 综合作业
...
## 十三、待验证假设（Training前/Training中） / 十三、待验证假设（培训前/培训中）
