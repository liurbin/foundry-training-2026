...
> Bilingual mirror. Original source: `docs/03-workshop-fork-mapping.md`.
...
- Chinese canonical title: 原 workshop ↔ v2 课程对照表
- English navigation title: Original Workshop to v2 Course Mapping
- Scope: this page is part of the full bilingual Foundry training site.

## Chinese Source with Bilingual Headings

# Original Workshop to v2 Course Mapping / 原 workshop ↔ v2 课程对照表
