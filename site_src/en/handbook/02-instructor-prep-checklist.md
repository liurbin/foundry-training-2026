# Instructor Day-7 Preparation Checklist

> Bilingual mirror. Original source: `docs/02-instructor-prep-checklist.md`.
...
- Chinese canonical title: 讲师 Day-7 准备清单
- English navigation title: Instructor Day-7 Preparation Checklist
- Scope: this page is part of the full bilingual Foundry training site.

## Chinese Source with Bilingual Headings

# Instructor Day-7 Preparation Checklist / 讲师 Day-7 准备清单
...
## D3: Single-Agent Platform Path / D3: 单 agent 平台路径
...
## D4: Provider Abstraction / D4: Provider 抽象
...
## D5: Deployment, Capacity, Scaling, and Cost / D5: 部署与容量模式 + Scaling + Cost
...
## D8: Red-Team Baseline / D8: 红队 Baseline
...
## D10: Foundry Capability Boundary Table / D10: Foundry 能力边界表
...
## Handling Unfinished Items / 未完成项处理
