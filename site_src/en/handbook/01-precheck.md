# Learner前置PreparationChecklist

> Bilingual mirror. Original source: `docs/01-precheck.md`.
...
- Chinese canonical title: 学员前置准备清单
- English navigation title: Learner前置PreparationChecklist
- Scope: this page is part of the full bilingual Foundry training site.

## Chinese Source with Bilingual Headings

# Learner前置PreparationChecklist / 学员前置准备清单
...
## 二、账号 gating（最重要，过不去Training作废） / 二、账号 gating（最重要，过不去培训作废）

### Training日 -14 天 必须完成 / 培训日 -14 天 必须完成
...
### ⚠️ 这三项任意一项不满足 → 直接联系Training组协调，不要硬等 / ⚠️ 这三项任意一项不满足 → 直接联系培训组协调，不要硬等

## 三、必装工具Checklist / 三、必装工具清单
...
## 五、必读资料（Training前预习，1-2 小时） / 五、必读资料（培训前预习，1-2 小时）
