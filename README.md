...
- [~] **Day-7 by 讲师**：D10 边界表 14 行验证来源——**官方文档 URL 已预填**（agent 2026/05 抓取核对，覆盖 Agent Service / Workflows / Quotas / Capacity / Hosted agents / Red Teaming / Tracing / A2A 等关键行）；portal 截图 / fork 实测 / 订阅级 region 可用性 **仍待讲师 Day-7 补**
